...
# ==================== PDF 配置 ====================
# 中文字体路径
CHINESE_FONT_PATH = os.getenv("WSJ_CHINESE_FONT", "/System/Library/Fonts/Supplemental/Songti.ttc")
ARIAL_UNICODE_PATH = os.getenv("WSJ_ARIAL_FONT", "/System/Library/Fonts/Supplemental/Arial Unicode.ttf")
